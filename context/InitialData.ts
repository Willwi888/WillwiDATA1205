...
export const OFFICIAL_CATALOG: Song[] = [
    ...
    { id: id('XinHuang'), title: '心慌', isrc: 'TWXINHUANG', releaseDate: '2025-11-17', releaseCategory: ReleaseCategory.Single, language: Language.Mandarin, projectType: ProjectType.Indie, coverUrl: ASSETS.defaultCover, isInteractiveActive: true, isEditorPick: false, origin: 'local', credits: STANDARD_CREDITS },
    ...
    { id: id('Forever'), title: 'Forever', isrc: 'TWFOREVER', releaseDate: '2025-10-15', releaseCategory: ReleaseCategory.Single, language: Language.English, projectType: ProjectType.Indie, coverUrl: ASSETS.defaultCover, isInteractiveActive: true, isEditorPick: false, origin: 'local', credits: STANDARD_CREDITS },
    ...
    { id: id('GuangNian'), title: '光年', isrc: 'TWLIGHTYEAR', releaseDate: '2025-09-20', releaseCategory: ReleaseCategory.Single, language: Language.Mandarin, projectType: ProjectType.Indie, coverUrl: ASSETS.defaultCover, isInteractiveActive: true, isEditorPick: false, origin: 'local', credits: STANDARD_CREDITS },
